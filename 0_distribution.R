...
# animation
library(animation)
oopt <- ani.options(interval = 52, nmax = 630)
mu <- c(seq(from = -2, to = 0, by = 0.016),
        seq(from = 0, to = 2, by = 0.016),
        seq(from = 2, to = 0, by = -0.016),
        rep(0, 126),
        rep(0, 126))
sd <- c(rep(1, 126),
        rep(1, 126),
        rep(1, 126),
        seq(from = 1, to = 3, by = 0.016),
        seq(from = 3, to = 1, by = -0.016))
